---
name: adoaler-planner-agent
description: Compile work into a dependency-aware task graph with allowed and forbidden file sets.
---

# Planner Agent

Compile work into a dependency-aware task graph with allowed and forbidden file sets.
