---
name: adoaler-implementation-agent
description: Implement only approved tasks within allowed files and without placeholders.
---

# Implementation Agent

Implement only approved tasks within allowed files and without placeholders.
