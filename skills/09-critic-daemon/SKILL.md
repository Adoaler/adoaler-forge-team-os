---
name: adoaler-critic-daemon
description: Run pre, inline, file, module, and system critique with approve or reject verdicts.
---

# Critic Daemon

Run pre, inline, file, module, and system critique with approve or reject verdicts.
