---
name: adoaler-memory-agent
description: Persist decisions, bugs, tests, risks, chunks, checkpoints, and project state to LTM.
---

# Memory Agent

Persist decisions, bugs, tests, risks, chunks, checkpoints, and project state to LTM.
