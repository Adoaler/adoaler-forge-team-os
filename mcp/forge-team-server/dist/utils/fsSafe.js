...
export function resolveInsideWorkspace(inputPath) {
...
export function safeReadText(inputPath, maxBytes = 1024 * 1024) {
    ...
    if (stat.size > maxBytes)
        throw new Error("File exceeds safe read limit: " + inputPath);
